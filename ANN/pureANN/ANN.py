...
np.save('RMSE_Psi1_100days_predictions_pureANN_npc=150_norm=own_nic=9990_ntrain=400K_ntest=100K',meanRMSE)
...
#plt.savefig('RMSE_Psi1_100days_predictions_pureANN_npc=150_norm=own_nic=9990_ntrain=400K_ntest=100K.png',dpi=100)
#plt.close()
...
plt.colorbar()
plt.clim([0, 1])
plt.savefig('ITCC_Psi1_100days_predictions_pureANN_npc=150_norm=own_nic=9990_ntrain=400K_ntest=100K.png',dpi=100)
plt.close()
np.save('ITCC_Psi1_100days_predictions_pureANN_npc=150_norm=own_nic=9990_ntrain=400K_ntest=100K',meanitcc)
...
#plt.ylim([0.7, 1])
#plt.grid(color='k', linestyle='--', linewidth=0.2)
#plt.savefig('ISCC_Psi1_100days_predictions_pureANN_npc=150_norm=own_nic=9990_ntrain=400K_ntest=100K.png',dpi=100)
#plt.close()
np.save('ISCC_Psi1_100days_predictions_pureANN_npc=150_norm=own_nic=9990_ntrain=400K_ntest=100K',meaniscc)
"""
################################################################
###################### Long term forecasts #####################
################################################################
...
plt.clim(-20, 20)
plt.colorbar()
plt.savefig('Climatology_Psi1_200Kdays_predictions_pureANN_npc=150_norm=own_nic=1_ntrain=400K_ntest=100K.png',dpi=100)
plt.close()
np.save('Climatology_Psi1_200Kdays_predictions_pureANN_npc=150_norm=own_nic=1_ntrain=400K_ntest=100K',mean_psi1_climatology_pred)

plt.imshow(mean_psi1_variance_pred.reshape(nx,ny), origin='lower', cmap='jet')
plt.clim(0, 100000)
plt.colorbar()
plt.savefig('Variance_Psi1_200Kdays_predictions_pureANN_npc=150_norm=own_nic=1_ntrain=400K_ntest=100K.png',dpi=100)
plt.close()
np.save('Variance_Psi1_200Kdays_predictions_pureANN_npc=150_norm=own_nic=1_ntrain=400K_ntest=100K',mean_psi1_variance_pred)

# Frequency map of the predictions
plt.imshow(np.array(mean_freq_pred).reshape(nx,ny), origin='lower', cmap='jet')
plt.colorbar()
plt.clim([0,4])
plt.savefig('Frequency_Psi1_200Kdays_predictions_pureANN_npc=150_norm=own_nic=1_ntrain=400K_ntest=100K.png',dpi=300)
plt.close()
np.save('Frequency_Psi1_200Kdays_predictions_pureANN_npc=150_norm=own_nic=1_ntrain=400K_ntest=100K',mean_freq_pred)
