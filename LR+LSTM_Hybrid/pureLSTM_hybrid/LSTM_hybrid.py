...
plt.close()
np.save('Climatology_Psi1_200Kdays_predictions_pureLSTM_hybrid_npc=150_norm=own_nic=1_ntrain=400K_ntest=100K',mean_psi1_climatology_pred)
...
plt.close()
np.save('Variance_Psi1_200Kdays_predictions_pureLSTM_hybrid_npc=150_norm=own_nic=1_ntrain=400K_ntest=100K',mean_psi1_variance_pred)
"""
plt.imshow(np.array(mean_freq_pred).reshape(nx,ny), origin='lower', cmap='jet')
plt.colorbar()
plt.clim([0,4])
plt.savefig('Frequency_Psi1_200Kdays_predictions_pureLSTM_hybrid_npc=150_norm=own_nic=1_ntrain=400K_ntest=100K.png',dpi=300)
plt.close()
np.save('Frequency_Psi1_200Kdays_predictions_pureLSTM_hybrid_npc=150_norm=own_nic=1_ntrain=400K_ntest=100K',mean_freq_pred)
