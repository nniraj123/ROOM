...
def forecast(n_ensem, n_pred, n_in_param, x_start, deltaT,
             linregmodel, scaler, dW):
    ...
    for i in range(n_ensem):
        ...
        for j in range(n_pred):
            out3 = out2
            out2 = out1
            # Use the neural network to predict the right-hand-side
            out1 = linregmodel.predict(state) + dW[i*n_pred+j,:]
        ...
        y_pred[i,:,:] = scaler.inverse_transform(temp)
