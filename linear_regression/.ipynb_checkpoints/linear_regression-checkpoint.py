...
plt.clim(-20, 20)
plt.colorbar()
plt.savefig('Climatology_Psi1_200Kdays_predictions_SLR_npc=150_nic=1_ntrain=400K_ntest=100K.png',dpi=100)
plt.close()

plt.imshow(mean_psi1_variance_pred.reshape(nx,ny), origin='lower', cmap='jet')
plt.clim(0, 100000)
plt.colorbar()
plt.savefig('Variance_Psi1_200Kdays_predictions_SLR_npc=150_nic=1_ntrain=400K_ntest=100K.png',dpi=100)
plt.close()
...
plt.colorbar()
plt.clim([0,4])
plt.savefig('Frequency_Psi1_200Kdays_predictions_SLR_npc=150_nic=1_ntrain=400K_ntest=100K.png',dpi=100)
plt.close()
del psi1_pred
...
for kk in range(n_ic):
    psi1_true = np.float32(pcs[kk:kk+n_maxlead,:]).dot(np.float32(eofs))
...
plt.colorbar()
plt.clim([0,4])
plt.savefig('Frequency_Psi1_200Kdays_true_npc=150_nic=1.png',dpi=100)
plt.close()
